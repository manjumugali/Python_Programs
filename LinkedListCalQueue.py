"""
******************************************************************************
* Purpose: Program To Implement Queue to print cal of the month.
*
...
class LinkedListQueueCal:
    try:
        ...
        for i in weeks:
            l1.enQueue(i)  # read the days and push into Queue
        print()
        var = days[month - 1]
        for i in range(1, var + 1):
            l2.enQueue(i)   # invoking push method to add elements to queue
        print()
        print("      ", months[month - 1], "-", year)
        print("---------------------------")
        for i in range(1, 8):
            print(l1.deQueue(), end=" ")    # invoking pop method to remove elements
        print()
        ...
        for i in range(1, var + 1):
            if i <= 5:
                print("", l2.deQueue(), " ", end="")    # invoking pop method to remove elements
            if 5 < i < 10:
                print("", l2.deQueue(), " ", end="")    # invoking pop method to remove elements
            if i > 9:
                print("", l2.deQueue(), "", end="")   # invoking pop method to remove elements
